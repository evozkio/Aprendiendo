...
def add_contact_tk(contacts, name, phone, email, frame_contact_list):
    ...
    print_contact(contact,frame_contact_list)


def print_contact(contact ,frame_contact_list):
...
def main():
    ...
    ttk.Label(frame_add_contact, text="Nombre", padding="10").grid(column=1, row=1)
    ttk.Label(frame_add_contact, text="Email").grid(column=2, row=1)
    ttk.Label(frame_add_contact, text="Telefono").grid(column=3, row=1)

    ttk.Entry(frame_add_contact, width=15, textvariable=name).grid(column=1, row=2, sticky=(W))
    ttk.Entry(frame_add_contact, width=30, textvariable=email).grid(column=2, row=2)
    ttk.Entry(frame_add_contact, width=12, textvariable=phone).grid(column=3, row=2)
